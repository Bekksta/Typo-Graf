...
- **Легковесный.** Бандл — 44 КБ. Никаких кастомных UI-фреймворков, тяжёлых ассетов и стартовых заставок.
...
В конце работы плагин закрывается и Figma показывает нативный notify с финальной сводкой:

```
Готово · языки: русский, английский · изменений: 142 · затронуто узлов: 38 · Ctrl/⌘+Z — отменить
```
...
│   └── maps.ts          QUOTES, LANG_LABEL, символы (NBSP, NNBSP, EM_DASH...)
